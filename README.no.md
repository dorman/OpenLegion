...
brew install anomalyco/tap/openlegion # macOS og Linux (anbefalt, alltid oppdatert)
brew install openlegion              # macOS og Linux (offisiell brew-formel, oppdateres sjeldnere)
...
OpenLegion er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/dorman/OpenLegion/releases) eller [openlegion.dev/download](https://openlegion.dev/download).
...
1. `$OPENLEGION_INSTALL_DIR` - Egendefinert installasjonsmappe
...
OpenLegion har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://openlegion.dev/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer OpenLegion, [**se dokumentasjonen**](https://openlegion.dev/docs).

### Bidra

Hvis du vil bidra til OpenLegion, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på OpenLegion

Hvis du jobber med et prosjekt som er relatert til OpenLegion og bruker "openlegion" som en del av navnet; for eksempel "openlegion-dashboard" eller "openlegion-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av OpenLegion-teamet og ikke er tilknyttet oss på noen måte.

---

**Bli med i fellesskapet** [Discord](https://discord.gg/openlegion) | [X.com](https://x.com/openlegion)
