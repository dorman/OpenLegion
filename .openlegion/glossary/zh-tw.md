...
- PR #13942: https://github.com/dorman/OpenLegion/pull/13942

## Do Not Translate (Locale Additions)

- `OpenLegion` (preserve casing in prose; keep `openlegion` only when it is part of commands, package names, paths, or code)
- `OpenLegion Zen`
- `OpenLegion CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `openlegion` in prose when referring to the product name; use `OpenLegion`
