...
- PR #10018: https://github.com/dorman/OpenLegion/pull/10018
- PR #12935: https://github.com/dorman/OpenLegion/pull/12935

## Do Not Translate (Locale Additions)

- `OpenLegion` (preserve casing in prose; keep `openlegion` only in commands, package names, paths, or code)
- `OpenLegion CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
