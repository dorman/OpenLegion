...
Use this folder for locale-specific translation guidance that supplements `.openlegion/agent/translator.md`.
...
- PR #12345: https://github.com/dorman/OpenLegion/pull/12345

## Do Not Translate (Locale Additions)

- `OpenLegion` (preserve casing)
