...
- PR #15835: https://github.com/dorman/OpenLegion/pull/15835

## Do Not Translate (Locale Additions)

- `OpenLegion` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `openlegion` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OpenLegion` in prose, `openlegion` only for exact technical identifiers
...
- Avoid changing `openlegion` to `OpenLegion` inside commands, URLs, package names, or code literals
