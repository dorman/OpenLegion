...
Desktop application and browser-based app issues, including `openlegion web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core openlegion server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

OpenLegion Zen, OpenLegion Go, and billing issues.
