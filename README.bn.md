...
# Package managers
npm i -g openlegion-ai@latest        # or bun/pnpm/yarn
scoop install openlegion             # Windows
choco install openlegion             # Windows
brew install anomalyco/tap/openlegion # macOS and Linux (recommended, always up to date)
brew install openlegion              # macOS and Linux (official brew formula, updated less)
sudo pacman -S openlegion            # Arch Linux (Stable)
paru -S openlegion-bin               # Arch Linux (Latest from AUR)
mise use -g openlegion               # Any OS
nix run nixpkgs#openlegion           # or github:dorman/OpenLegion for latest dev branch
```
...
OpenLegion ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/dorman/OpenLegion/releases) অথবা [openlegion.dev/download](https://openlegion.dev/download) থেকে ডাউনলোড করুন।
...
1. `$OPENLEGION_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.openlegion/bin` - ডিফল্ট ফলব্যাক
...
OpenLegion এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://openlegion.dev/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে OpenLegion কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://openlegion.dev/docs)।

### অবদান (Contributing)

আপনি যদি OpenLegion এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### OpenLegion এর উপর বিল্ডিং (Building on OpenLegion)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা OpenLegion এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "openlegion" ব্যবহার করেন, উদাহরণস্বরূপ "openlegion-dashboard" বা "openlegion-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি OpenLegion দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/openlegion) | [X.com](https://x.com/openlegion)
