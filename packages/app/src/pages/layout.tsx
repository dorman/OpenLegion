...
import { Session, type Message } from "@openlegion-ai/sdk/v2/client"
...
import { toaster } from "@openlegion-ai/ui/toast"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://openlegion.dev/desktop-feedback")}
      renderPanel={() =>
