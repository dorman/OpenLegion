import { containers as containersI18n } from "./containers/da"
...
export const dict = {
  ...
  "dialog.provider.openlegion.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.openlegion.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.openlegionGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OpenLegion",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OpenLegion.",
  ...
  "provider.connect.openlegionZen.line1":
    "OpenLegion Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.openlegionZen.visit.prefix": "Besøg ",
  "provider.connect.openlegionZen.visit.link": "openlegion.dev/zen",
  "provider.connect.openlegionZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OpenLegion.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OpenLegion.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i openlegion.json",
  ...
  "dialog.server.description": "Skift hvilken OpenLegion-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af OpenLegion ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OpenLegion-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (openlegion.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OpenLegion understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OpenLegion inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OpenLegion-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OpenLegion",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan OpenLegion ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OpenLegion følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OpenLegion er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OpenLegion starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OpenLegion.",
