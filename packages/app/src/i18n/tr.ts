...
import { containers as containersI18n } from "./containers/tr"
...
export const dict = {
  ...
  "dialog.provider.openlegion.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.openlegion.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.openlegionGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenLegion tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OpenLegion'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.openlegionZen.line1":
    "OpenLegion Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.openlegionZen.visit.prefix": "",
  "provider.connect.openlegionZen.visit.link": "openlegion.dev/zen",
  "provider.connect.openlegionZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve OpenLegion'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenLegion'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler openlegion.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OpenLegion sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "OpenLegion'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OpenLegion ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (openlegion.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OpenLegion henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OpenLegion ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OpenLegion Masaüstü",
  ...
  "settings.desktop.wsl.description": "OpenLegion sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OpenLegion'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "OpenLegion'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OpenLegion'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OpenLegion'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OpenLegion başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OpenLegion'un en son sürümünü kullanıyorsunuz.",
