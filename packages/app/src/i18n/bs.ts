export const dict = {
  ...
  "dialog.provider.openlegion.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.openlegion.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.openlegionGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OpenLegion",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenLegion-u.",
  ...
  "provider.connect.openlegionZen.line1":
    "OpenLegion Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.openlegionZen.visit.prefix": "Posjeti ",
  "provider.connect.openlegionZen.visit.link": "openlegion.dev/zen",
  "provider.connect.openlegionZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenLegion-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenLegion-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u openlegion.json",
  ...
  "dialog.server.description": "Promijeni na koji se OpenLegion server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija OpenLegion-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OpenLegion timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (openlegion.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OpenLegion još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenLegion uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OpenLegion server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OpenLegion-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako OpenLegion izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OpenLegion prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OpenLegion-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OpenLegion pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OpenLegion-a.",
