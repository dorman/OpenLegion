export const dict = {
  ...
  "agents.workflow.title": "Start a workflow",
  "agents.workflow.description": "Pick a flow and an agent guides you through it in chat.",
  "agents.workflow.docker.pill": "DOCKER",
  "agents.workflow.docker.title": "New Docker sandbox",
  "agents.workflow.docker.description": "Create and run a container — the agent picks the image and network with you.",
  "agents.workflow.kubernetes.pill": "KUBERNETES",
  "agents.workflow.kubernetes.title": "New Kubernetes sandbox",
  "agents.workflow.kubernetes.description": "Create a workload on the local kind cluster.",
  "agents.workflow.linuxVm.pill": "LINUX VM",
  "agents.workflow.linuxVm.title": "Set up a Linux VM host",
  "agents.workflow.linuxVm.description": "Install the daemon and Kata on a separate tower, then connect this app to it.",
  "agents.workflow.readDocs.pill": "DOCS",
  "agents.workflow.readDocs.title": "Read the docs",
  "agents.workflow.readDocs.description": "Ask about OpenLegion's docs and repo — setup, engines, the daemon API.",
  "agents.workflow.debugNet.pill": "NETWORK",
  "agents.workflow.debugNet.title": "Debug a network issue",
  "agents.workflow.debugNet.description": "Diagnose why a sandbox can't reach the network — interfaces, routing, DNS.",
  "agents.workflow.cloneRepo.pill": "REPO",
  "agents.workflow.cloneRepo.title": "Clone a repo into a sandbox",
  "agents.workflow.cloneRepo.description": "Pull a git repository into a sandbox and get it ready to work on.",
