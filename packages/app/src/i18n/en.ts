export const dict = {
  ...
  "dialog.provider.local.label": "Local model",
  "dialog.provider.local.tagline": "Run models on this Mac (Ollama, LM Studio, Unsloth)",
  "dialog.provider.openlegion.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.openlegion.tagline": "Reliable optimized models",
  "dialog.provider.openlegionGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenLegion",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenLegion.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.openlegionZen.line1":
    "OpenLegion Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.openlegionZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.openlegionZen.visit.prefix": "Visit ",
  "provider.connect.openlegionZen.visit.link": "openlegion.dev/zen",
  "provider.connect.openlegionZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenLegion.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenLegion.",
  ...
  "provider.local.title": "Local model",
  "provider.local.description.prefix": "Connect a model server running on this Mac. Start ",
  "provider.local.description.link": "Ollama, LM Studio, or Unsloth",
  "provider.local.description.suffix": ", then detect the models it's serving.",
  "provider.local.preset.ollama": "Ollama",
  "provider.local.preset.lmstudio": "LM Studio",
  "provider.local.preset.unsloth": "Unsloth",
  "provider.local.preset.custom": "Custom",
  "provider.local.field.providerID.label": "Provider ID",
  "provider.local.field.providerID.placeholder": "my-local",
  "provider.local.field.providerID.description": "Lowercase letters, numbers, hyphens, or underscores",
  "provider.local.field.name.label": "Display name",
  "provider.local.field.name.placeholder": "My local models",
  "provider.local.field.baseURL.label": "Server URL",
  "provider.local.field.baseURL.description": "The OpenAI-compatible endpoint, e.g. http://localhost:11434/v1",
  "provider.local.field.apiKey.label": "API key",
  "provider.local.field.apiKey.placeholder": "sk-…",
  "provider.local.field.apiKey.description": "Optional — most local servers (Ollama, LM Studio, Unsloth) don't need one; add a key only if yours is configured to require it.",
  "provider.local.detect.action": "Detect models",
  "provider.local.detect.loading": "Detecting…",
  "provider.local.detect.empty": "The server responded but reported no models. Load a model, or enter model IDs manually.",
  "provider.local.detect.failed": "Couldn't reach that server. Make sure it's running, or enter model IDs manually.",
  "provider.local.models.label": "Models",
  "provider.local.models.manual.label": "Model IDs",
  "provider.local.models.manual.placeholder": "llama3.1, qwen2.5-coder",
  "provider.local.models.manual.description": "Comma or newline separated model IDs",
  "provider.local.error.providerID.required": "Provider ID is required",
  "provider.local.error.providerID.format": "Use lowercase letters, numbers, hyphens, or underscores",
  "provider.local.error.baseURL.required": "Server URL is required",
  "provider.local.error.baseURL": "Must start with http:// or https://",
  "provider.local.error.models": "Add at least one model",
  ...
  "dialog.plugins.empty": "Plugins configured in openlegion.json",
  ...
  "dialog.server.description": "Switch which OpenLegion server this app connects to.",
  ...
  "toast.update.description": "A new version of OpenLegion ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenLegion team",
  ...
  "error.chain.checkConfig": "Check your config (openlegion.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenLegion does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenLegion includes free models so you can start immediately.",
  ...
  "containers.ensureDaemon.ready": "Sandbox daemon is running",
  "containers.ensureDaemon.failed": "Failed to start sandbox daemon",
  "containers.runtime.title": "Local runtimes",
  "containers.runtime.ready": "Ready",
  "containers.runtime.unavailable": "Unavailable",
  "containers.error.noServer": "No local server is connected.",
  ...
  "containers.openSession.description":
    "Run an agent in this container. Choose the host project directory that is bind-mounted into the sandbox.",
  "containers.openSession.project": "Host project directory",
  "containers.openSession.pickProject": "Choose project directory",
  "containers.openSession.projectRequired": "Choose a host project directory for this container.",
  ...
  "containers.choose.docker.description":
    "A Linux container on the local Docker engine — for tools, services, or an agent workspace.",
  "containers.choose.kubernetes.pill": "KUBERNETES",
  "containers.choose.kubernetes.title": "Kubernetes workload",
  "containers.choose.kubernetes.description": "A pod on the local kind cluster, for dev and cloud-native work.",
  "containers.choose.linuxVm.pill": "LINUX VM",
  "containers.choose.linuxVm.title": "Linux VM (research host)",
  "containers.choose.linuxVm.description":
    "A hardware-isolated Kata micro-VM on a separate Linux tower, for malware analysis. The agent walks you through host setup.",
  ...
  "containers.inspect": "Logs, shell & desktop",
  "containers.inspect.title": "{{name}} sandbox",
  "containers.inspect.description": "View logs, open a shell, or connect to a remote desktop when available.",
  "containers.inspect.tab.logs": "Logs",
  "containers.inspect.tab.shell": "Shell",
  "containers.inspect.tab.display": "Desktop",
  "containers.inspect.autoRefresh": "Auto-refresh logs",
  "containers.inspect.refresh": "Refresh",
  "containers.inspect.logsEmpty": "No logs yet.",
  "containers.inspect.shellTitle": "Interactive shell",
  "containers.inspect.copyShell": "Copy command",
  "containers.inspect.shellUnavailable": "Built-in shell is only available in OpenLegion Desktop.",
  "containers.inspect.shellStopped": "This container is not running. Start it to open a shell.",
  "containers.inspect.displayStopped": "This workload is not running. Start it to open the desktop.",
  ...
  "containers.inspect.displayFocus":
    "Click inside the black display area before typing. If Enter does nothing in Firefox, click the address-bar arrow or open a site from the Shell tab with: firefox http://example.com",
  "containers.inspect.displayViewport": "Remote desktop display",
  ...
  "containers.inspect.askAgent": "Ask agent",
  "containers.inspect.askAgentFailed": "Could not open an agent session",
  ...
  "containers.create.preset.debian13Arm64": "Debian 13 netinst (arm64)",
  "containers.create.preset.debian13Amd64": "Debian 13 netinst (amd64)",
  ...
  "containers.create.preset.downloadHint":
    "First create downloads the installer ISO for your machine (typically 700 MB–1 GB) to ~/.openlegion/images. Later creates reuse the cached file.",
  "containers.create.preset.downloadNotice":
    "Creating this sandbox will download the {distro} installer ISO. This is a one-time download and can take several minutes depending on your connection.",
  "containers.create.preset.downloading": "Downloading {distro} installer…",
  "containers.create.preset.downloadingCached": "Found cached {distro} installer. Finishing setup…",
  "containers.create.preset.downloadingChecking": "Preparing {distro} installer download…",
  "containers.create.preset.downloadingFinishing": "Finishing {distro} installer download…",
  "containers.create.preset.downloadingProgress": "{downloaded} MB downloaded so far",
  "containers.create.preset.downloadingElapsed": "Elapsed: {elapsed}",
  "containers.create.preset.downloadingReassurance":
    "The app is still working. Large Linux installer images can take 5–15 minutes on slower connections—please keep this dialog open.",
  "containers.create.preset.downloadingSubmit": "Downloading installer…",
  ...
  "containers.templates.title": "Quick start",
  "containers.templates.hint": "Apply a starter template, then adjust image, mounts, and resources before creating.",
  "containers.templates.alpineDev.label": "Alpine dev",
  "containers.templates.alpineDev.description": "Lightweight shell container for quick experiments.",
  "containers.templates.nodeBind.label": "Node + bind mount",
  "containers.templates.nodeBind.description": "Node.js runtime with a workspace bind mount ready for agent sessions.",
  "containers.templates.ubuntuDesktop.label": "Ubuntu desktop",
  "containers.templates.ubuntuDesktop.description": "Download an Ubuntu installer and create a Linux desktop VM.",
  "containers.create.cpuCores": "CPU cores",
  "containers.create.diskGb": "Disk (GB)",
  "containers.create.preset.downloadCancel": "Cancel download",
  "containers.create.preset.downloadRetry": "Retry download",
  "containers.create.preset.downloadCancelled": "Installer download cancelled.",
  "containers.bulk.selectAll": "Select all visible",
  "containers.bulk.selected": "{{count}} selected",
  "containers.bulk.start": "Start selected",
  "containers.bulk.stop": "Stop selected",
  "containers.bulk.remove": "Remove selected",
  "containers.bulk.startDone": "Started {{count}} sandboxes",
  "containers.bulk.stopDone": "Stopped {{count}} sandboxes",
  "containers.bulk.removeDone": "Removed {{count}} sandboxes",
  "containers.bulk.startFailed": "Failed to start selected sandboxes",
  "containers.bulk.stopFailed": "Failed to stop selected sandboxes",
  "containers.bulk.removeFailed": "Failed to remove selected sandboxes",
  "containers.filter.status": "Status",
  "containers.filter.status.all": "All statuses",
  "containers.filter.status.running": "Running",
  "containers.filter.status.stopped": "Stopped",
  "containers.filter.kind": "Workload",
  "containers.filter.kind.all": "All workloads",
  "containers.filter.kind.container": "Containers",
  "containers.filter.kind.desktop": "Linux desktops",
  "containers.filter.noResults": "No sandboxes match the current filters.",
  "containers.warnings.title": "Risky configuration",
  ...
  "home.empty.guided.createSandbox.action": "Open sandboxes",
  "home.empty.guided.startDaemon.title": "Start the sandbox daemon",
  ...
  "home.agents.filter.active": "Active",
  "home.agents.filter.attention": "Needs attention",
  "home.agents.sandboxLink": "Sandbox: {{name}}",
  ...
  "containers.compose.stop": "Stop stack",
  "containers.compose.deploying": "Deploying…",
  "containers.compose.stopping": "Stopping…",
  ...
  "containers.create.security.pinDigest": "Pin base images by digest (@sha256:…) for reproducible builds.",
  "containers.create.security.minimal": "Keep images minimal: fewer packages mean a smaller attack surface.",
  "containers.inspect.copyLogs": "Copy logs",
  "containers.inspect.copyLogsDone": "Logs copied to clipboard",
  "containers.inspect.fullscreen": "Fullscreen desktop",
  "containers.inspect.exitFullscreen": "Exit fullscreen",
  "containers.inspect.tab.audit": "Audit",
  "containers.inspect.audit.description":
    "Recent sandbox permission events recorded on this machine (compose deploy/stop and future agent actions).",
  "containers.inspect.audit.empty": "No sandbox audit events recorded for this workload yet.",
  "containers.desktop.hostAgentHint":
    "Use Ask agent for host-side help with this desktop VM, or Inspect → Desktop for the live GUI. Open session requires a container workload.",
  "desktop.linkedSandboxes.title": "Linked projects",
  "desktop.daemon.title": "Sandbox daemon",
  "desktop.daemon.ready": "Online",
  "desktop.daemon.unavailable": "Offline",
  "desktop.nav.label": "Desktop navigation",
  "desktop.nav.agents": "Agents",
  "session.header.container": "Sandbox container",
  "session.header.container.tooltip": "Shell commands run in container {id}",

  "app.name.desktop": "OpenLegion Desktop",
  ...
  "settings.desktop.wsl.description": "Run the OpenLegion server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenLegion",
  ...
  "settings.general.row.appearance.description": "Customise how OpenLegion looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenLegion follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenLegion is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenLegion launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenLegion.",
