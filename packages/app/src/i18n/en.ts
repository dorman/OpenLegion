export const dict = {
  ...
  "containers.inspect": "Logs & shell",
  "containers.inspect.title": "{{name}} logs & shell",
  "containers.inspect.description": "View container output and use a built-in terminal shell.",
  ...
  "containers.inspect.shellStopped": "Start the container to open a shell.",
