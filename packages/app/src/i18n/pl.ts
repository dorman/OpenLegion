import { containers as containersI18n } from "./containers/pl"
...
export const dict = {
  ...
  "dialog.provider.openlegion.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.openlegion.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.openlegionGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenLegion",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenLegion.",
  ...
  "provider.connect.openlegionZen.line1":
    "OpenLegion Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.openlegionZen.visit.prefix": "Odwiedź ",
  "provider.connect.openlegionZen.visit.link": "openlegion.dev/zen",
  "provider.connect.openlegionZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenLegion.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenLegion.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openlegion.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenLegion, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OpenLegion ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenLegion",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openlegion.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OpenLegion zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenLegion",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenLegion na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenLegion ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenLegion.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenLegion",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenLegion.",
