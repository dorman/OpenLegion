export const dict = {
  ...
  "dialog.provider.openlegion.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.openlegion.tagline": "Modelos optimizados y fiables",
  "dialog.provider.openlegionGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OpenLegion",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OpenLegion.",
  ...
  "provider.connect.openlegionZen.line1":
    "OpenLegion Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.openlegionZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.openlegionZen.visit.prefix": "Visita ",
  "provider.connect.openlegionZen.visit.link": "openlegion.dev/zen",
  "provider.connect.openlegionZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OpenLegion.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OpenLegion.",
  ...
  "dialog.plugins.empty": "Plugins configurados en openlegion.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de OpenLegion se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de OpenLegion ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de OpenLegion",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (openlegion.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, OpenLegion no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "OpenLegion incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OpenLegion",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve OpenLegion en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si OpenLegion sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OpenLegion.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OpenLegion",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OpenLegion.",
