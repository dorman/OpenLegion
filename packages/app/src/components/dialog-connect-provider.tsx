import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@openlegion-ai/sdk/v2/client"
...
import { List, type ListRef } from "@openlegion-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "openlegion"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openlegionZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openlegionZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.openlegionZen.visit.prefix")}
                <Link href="https://openlegion.dev/zen" tabIndex={-1}>
                  {language.t("provider.connect.openlegionZen.visit.link")}
                </Link>
                {language.t("provider.connect.openlegionZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
