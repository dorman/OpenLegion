...
beforeAll(async () => {
  ...
  mock.module("@openlegion-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openlegion-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openlegion-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openlegion-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
