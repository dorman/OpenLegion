...
const directory = "C:/OpenLegion/TimelineStateRegression"
...
const model = { providerID: "openlegion", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["openlegion"],
    default: { providerID: "openlegion", modelID: "claude-opus-4-6" },
  }
}
