...
class Database extends Context.Service<Database, DatabaseShape>()("@openlegion/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@openlegion/example/UserStore") {
