...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openlegion.git")).toEqual({ owner: "sst", repo: "openlegion" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openlegion")).toEqual({ owner: "sst", repo: "openlegion" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openlegion.git")).toEqual({ owner: "sst", repo: "openlegion" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openlegion")).toEqual({ owner: "sst", repo: "openlegion" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openlegion.git")).toEqual({ owner: "sst", repo: "openlegion" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openlegion")).toEqual({ owner: "sst", repo: "openlegion" })
})
