...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/openlegion/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/openlegion (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/openlegion/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/openlegion/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OPENLEGION_DB|OPENLEGION_DB|OPENLEGION_DEV|Global\\.Path\\.data|data =" in packages/openlegion/src (115 matches)',
  },
] as const
