...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENLEGION_CALLER", () => {
    process.env["OPENLEGION_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENLEGION_CALLER", () => {
    process.env["OPENLEGION_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENLEGION_CALLER", () => {
    process.env["OPENLEGION_CALLER"] = "unknown"
