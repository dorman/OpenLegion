  ...
  references.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "openlegion-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "openlegion-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "openlegion-glob-reference/repo",
        },
      },
    },
  )
