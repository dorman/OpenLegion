...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips openlegion-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-openlegion-directory"]).toBeUndefined()
      expect(forwarded["x-openlegion-workspace"]).toBeUndefined()
