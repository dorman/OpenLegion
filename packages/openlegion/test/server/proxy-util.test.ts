...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips openlegion-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-openlegion-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-openlegion-directory")).toBeNull()
      expect(result.get("x-openlegion-workspace")).toBeNull()
