...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      OPENLEGION_EXPERIMENTAL_WORKSPACES: Flag.OPENLEGION_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.OPENLEGION_EXPERIMENTAL_WORKSPACES = original.OPENLEGION_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
