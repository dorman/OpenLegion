...
import { ProjectDirectoryTable, ProjectTable } from "@openlegion-ai/core/project/sql"
...
import { which } from "@openlegion-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@openlegion/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.OPENLEGION_FAKE_VCS)
