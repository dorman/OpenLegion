import type { JsonSchema, LLMRequest, ProviderMetadata } from "@openlegion-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@openlegion-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @openlegion-ai/llm request objects from openlegion's session/AI SDK-shaped data.
  return LLM.request({
