import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@openlegion-ai/llm"
...
// Move this extraction into @openlegion-ai/llm when Copilot is handled by the native runtime.
