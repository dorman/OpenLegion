...
import { SessionEvent } from "@openlegion-ai/core/session/event"
import { ModelV2 } from "@openlegion-ai/core/model"
import { ProviderV2 } from "@openlegion-ai/core/provider"
import { AgentAttachment, FileAttachment, ReferenceAttachment, Source } from "@openlegion-ai/core/session/prompt"
...
import { LLMEvent } from "@openlegion-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@openlegion/SessionPrompt") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const containers = yield* Container.Service
      ...
      function* (sessionID: SessionID) {
        ...
        while (true) {
          ...
          const outcome: "break" | "continue" = yield* Effect.gen(function* () {
            ...
            const [skills, env, instructions, modelMsgs, sandboxCtx] = yield* Effect.all([
              sys.skills(agent),
