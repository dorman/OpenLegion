...
import { Slug } from "@openlegion-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@openlegion-ai/llm"
...
import { SessionV2 } from "@openlegion-ai/core/session"
...
import { PartTable, SessionTable } from "@openlegion-ai/core/session/sql"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@openlegion-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".openlegion", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@openlegion/Session") {}
