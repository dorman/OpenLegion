import type * as SDK from "@openlegion-ai/sdk/v2"
...
import { SessionShareTable } from "@openlegion-ai/core/share/sql"
import { ProviderV2 } from "@openlegion-ai/core/provider"
import { EventV2 } from "@openlegion-ai/core/event"

const log = Log.create({ service: "share-next" })
const disabled = process.env["OPENLEGION_DISABLE_SHARE"] === "true" || process.env["OPENLEGION_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@openlegion/ShareNext") {}
