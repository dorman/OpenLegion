...
import { AccountStateTable, AccountTable } from "@openlegion-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@openlegion/AccountRepo") {}
