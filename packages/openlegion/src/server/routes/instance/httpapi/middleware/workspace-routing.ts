...
>()("@openlegion/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@openlegion/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.OPENLEGION_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.OPENLEGION_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-openlegion-directory"] || process.cwd()
}
