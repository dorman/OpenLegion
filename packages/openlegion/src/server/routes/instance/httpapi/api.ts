...
export const RootHttpApi = HttpApi.make("openlegion-root")
  .addHttpApi(ControlApi)
  .addHttpApi(GlobalApi)
  .middleware(SchemaErrorMiddleware)
  .middleware(Authorization)

export const InstanceHttpApi = HttpApi.make("openlegion-instance")
...
export const OpenLegionHttpApi = HttpApi.make("openlegion")
