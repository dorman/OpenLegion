...
import "@openlegion-ai/core/catalog"
import "@openlegion-ai/core/session/event"
import { Context, Effect, Layer } from "effect"

export class Service extends Context.Service<Service, EventV2.Interface>()("@openlegion/EventV2Bridge") {}
