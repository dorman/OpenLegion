...
import { EventSequenceTable, EventTable } from "@openlegion-ai/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@openlegion/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OPENLEGION_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OPENLEGION_WORKSPACE_ID: config.id,
        OPENLEGION_EXPERIMENTAL_WORKSPACES: "true",
