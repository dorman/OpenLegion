...
import type { Event, GlobalEvent, OpencodeClient } from "@openlegion-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@openlegion/RunStreamTransport") {}
