...
//
// The saved variant persists across sessions in ~/.local/state/openlegion/model.json
...
class Service extends Context.Service<Service, VariantService>()("@openlegion/RunVariant") {}
