...
import { OPENLEGION_BASE_MODE, useBindings, useCommandShortcut, useOpencodeKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["openlegion", "openlegion-go"])
  ...
  createEffect(() => {
    ...
    return exit.message.set(
      [
        ...
        `  ${weak("Continue")}${UI.Style.TEXT_NORMAL_BOLD}openlegion -s ${session()?.id}${UI.Style.TEXT_NORMAL}`,
        ``,
      ].join("\n"),
    )
  })
