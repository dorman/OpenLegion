...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/dorman/OpenLegion/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("openlegion-version", InstallationVersion)
