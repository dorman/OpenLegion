...
export class Service extends Context.Service<Service, Interface>()("@openlegion/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __OPENLEGION_PHOTON_WASM_PATH?: string }).__OPENLEGION_PHOTON_WASM_PATH =
