 ...
 *   "@openlegion/ServerAuthConfig",
 *   {
 *     password: Config.string("OPENLEGION_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("OPENLEGION_SERVER_USERNAME").pipe(Config.withDefault("openlegion")),
 *   },
 * ) {}
 *
