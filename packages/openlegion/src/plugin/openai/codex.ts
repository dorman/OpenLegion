...
<html>
  <head>
    <title>OpenLegion - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>OpenLegion - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "openlegion"
      output.headers["User-Agent"] = `openlegion/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
