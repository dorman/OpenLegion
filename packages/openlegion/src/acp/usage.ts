...
import type { AssistantMessage as OpenLegionAssistantMessage, Message } from "@openlegion-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<OpenLegionAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<OpenLegionAssistantMessage, "role"> &
  Partial<Pick<OpenLegionAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@openlegion/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@openlegion/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@openlegion/ACPUsage") {}
