...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@openlegion/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@openlegion/ACPDirectory") {}
