...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/openlegion`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy openlegion service removed
