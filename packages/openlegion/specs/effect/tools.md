...
Practical reference for the current tool-migration state in `packages/openlegion`.
...
Tool tests should use the existing Effect helpers in `packages/openlegion/test/lib/effect.ts`:
