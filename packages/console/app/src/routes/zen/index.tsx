...
import compareVideo from "../../asset/lander/openlegion-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/openlegion-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="openlegion:auth" content={loggedin() ? "true" : "false"} />
