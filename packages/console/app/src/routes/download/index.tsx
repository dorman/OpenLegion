...
import desktopAppIcon from "../../asset/lander/openlegion-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://openlegion.dev/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>openlegion.dev/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g openlegion-ai")}>
                <code>
                  npm i -g <strong>openlegion-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g openlegion-ai")}>
                <code>
                  bun add -g <strong>openlegion-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/openlegion")}>
                <code>
                  brew install <strong>anomalyco/tap/openlegion</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S openlegion")}>
                <code>
                  paru -S <strong>openlegion</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask openlegion-desktop")}>
                <code>
                  brew install --cask <strong>openlegion-desktop</strong>
                </code>
                <CopyStatus />
              </button>
