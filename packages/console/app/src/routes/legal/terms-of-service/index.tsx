...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>OpenLegion | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="OpenLegion terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to OpenLegion. Please read on to learn the rules and restrictions that govern your use of
                OpenLegion&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("OpenLegion," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://openlegion.dev/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-openlegion">What is OpenLegion?</h2>
              <p>
                OpenLegion is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the OpenLegion Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, OpenLegion enables you to
              ...
              <p>
                ...
                our site located at openlegion.dev, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                OpenLegion takes the privacy of its users very seriously. For the current OpenLegion Privacy Policy, please
                click here{" "}
                <a href="https://openlegion.dev/legal/privacy-policy">https://openlegion.dev/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using OpenLegion?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by OpenLegion;
                </li>
                <li>
              ...
              <p>
                If you use OpenLegion with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                OpenLegion. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                OpenLegion has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-openlegion-ever-change-the-services">Will OpenLegion ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://openlegion.dev/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://openlegion.dev/auth">https://openlegion.dev/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://openlegion.dev/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                OpenLegion is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. OpenLegion has the sole right to decide whether you are
              ...
              <p>
                OpenLegion and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (OpenLegion and all such
                parties together, the "OpenLegion Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the OpenLegion Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The OpenLegion Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the OpenLegion Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without OpenLegion's prior written
              ...
              <p>
                ...
                disputes and claims with OpenLegion and limits the manner in which you can seek relief from OpenLegion. Both
                you and OpenLegion acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, OpenLegion's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. OpenLegion will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. OpenLegion will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or OpenLegion may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and OpenLegion are instead choosing to have claims and disputes resolved by
                ...
                you and OpenLegion over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                OpenLegion is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or OpenLegion to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and OpenLegion agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the OpenLegion may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and OpenLegion agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and OpenLegion, and
                ...
                are not an employee, agent, partner, or joint venture of OpenLegion, and you do not have any authority of
                any kind to bind OpenLegion in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and OpenLegion
