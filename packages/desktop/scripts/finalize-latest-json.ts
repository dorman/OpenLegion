...
const releaseId = process.env.OPENLEGION_RELEASE
if (!releaseId) throw new Error("OPENLEGION_RELEASE is required")

const version = process.env.OPENLEGION_VERSION
if (!version) throw new Error("OPENLEGION_VERSION is required")
...
const macxTarGz = "openlegion-desktop-mac-x64.app.tar.gz"
const macaTarGz = "openlegion-desktop-mac-arm64.app.tar.gz"
