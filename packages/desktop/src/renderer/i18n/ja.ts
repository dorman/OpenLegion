export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの OpenLegion を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenLegion のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'openlegion' コマンドを使用してください。",
