---
title: SDK
description: Type-safe JS client for openlegion server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The openlegion JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control openlegion programmatically.
...
Create an instance of openlegion:
...
You can pass a configuration object to customize behavior. The instance still picks up your `openlegion.json`, but you can override or add configuration inline:
...
If you already have a running instance of openlegion, you can create a client instance to connect to it:
