---
title: Zen
description: Lista seleccionada de modelos proporcionada por OpenLegion.
---
...
OpenLegion Zen es una lista de modelos probados y verificados proporcionada por el equipo de OpenLegion.

Zen funciona como cualquier otro proveedor en OpenLegion. Inicias sesión en OpenLegion Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con OpenLegion.
:::
...
OpenLegion Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

OpenLegion Zen funciona como cualquier otro proveedor en OpenLegion.

1. Inicias sesión en **<a href={console}>OpenLegion Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas OpenLegion Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de OpenLegion
usa el formato `openlegion/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`openlegion/gpt-5.5` en tu configuración.
...
- DeepSeek V4 Flash Free está disponible en OpenLegion por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en OpenLegion por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Super Free está disponible en OpenLegion por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en OpenLegion por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con OpenLegion.
