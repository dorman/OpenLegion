---
title: Teilen
description: Teile OpenLegion-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenLegion-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenLegion Folgendes:
...
OpenLegion hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenLegion den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`openlegion.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du openlegion in deiner Organisation einsetzt.
