---
title: SDK
description: Typsicherer JS-Client fuer den openlegion-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das openlegion JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und openlegion programmatisch steuern.
...
Erstelle eine openlegion-Instanz:
...
`openlegion.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn openlegion bereits laeuft, kannst du nur einen Client erstellen und verbinden:
