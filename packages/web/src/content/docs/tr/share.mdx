---
title: Paylasim
description: openlegion konusmalarini genel baglantilarla paylasin.
---

openlegion'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda openlegion:
...
openlegion, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak openlegion manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `openlegion.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda openlegion kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
