---
title: Özel Araçlar
description: LLM'un openlegion'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. openlegion'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.openlegion/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/openlegion/tools/` içine yerleştirerek.
