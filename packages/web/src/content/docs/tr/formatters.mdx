...
description: openlegion dile özgü biçimlendiriciler kullanır.
---

openlegion, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

openlegion, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, openlegion bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

openlegion bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri openlegion yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
