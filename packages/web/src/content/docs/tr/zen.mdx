---
title: Zen
description: openlegion tarafından sağlanan seçilmiş modeller listesi.
---
...
OpenLegion Zen, OpenLegion ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, OpenLegion'daki diğer sağlayıcılar gibi çalışır. OpenLegion Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve OpenLegion kullanmak için buna ihtiyacınız yoktur.
...
:::tip
OpenLegion ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
OpenLegion Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

OpenLegion Zen, OpenLegion'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>OpenLegion Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, OpenLegion Zen'i seçin ve API anahtarınızı yapıştırın.
...
OpenLegion yapılandırmanızdaki [model id](/docs/config/#models) `openlegion/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `openlegion/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için OpenLegion'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için OpenLegion'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Super Free, sınırlı bir süre için OpenLegion'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için OpenLegion'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
OpenLegion Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca OpenLegion ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
