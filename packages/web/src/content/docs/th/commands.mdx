...
สร้าง `.openlegion/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenLegion:
...
- ระดับผู้ใช้ (Global): `~/.config/openlegion/commands/`
- ระดับโปรเจ็กต์: `.openlegion/commands/`
...
OpenLegion มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
