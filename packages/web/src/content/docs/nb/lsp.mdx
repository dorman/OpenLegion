---
title: LSP-servere
description: openlegion integreres med LSP-serverne dine.
---

OpenLegion kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

OpenLegion kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `OPENLEGION_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og openlegion åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i OpenLegion-konfigurasjonen.
