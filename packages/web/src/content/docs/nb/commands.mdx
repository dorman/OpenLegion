...
Opprett `.openlegion/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OpenLegion-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenLegion [config](/docs/config):
...
- Per prosjekt: `.openlegion/commands/`
...
OpenLegion inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
