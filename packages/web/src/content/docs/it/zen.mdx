---
title: Zen
description: Lista curata di modelli fornita da OpenLegion.
---
...
OpenLegion Zen è un elenco di modelli testati e verificati forniti dal team di OpenLegion.

Zen funziona come qualsiasi altro provider in OpenLegion. Accedi a OpenLegion Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con OpenLegion.
:::
...
OpenLegion Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

OpenLegion Zen funziona come qualsiasi altro provider in OpenLegion.

1. Accedi a **<a href={console}>OpenLegion Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona OpenLegion Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di OpenLegion
usa il formato `openlegion/<model-id>`. Per esempio, per GPT 5.5, useresti
`openlegion/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su OpenLegion per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su OpenLegion per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su OpenLegion per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su OpenLegion per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato OpenLegion Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con OpenLegion.
