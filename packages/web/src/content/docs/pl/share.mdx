---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące openlegion.
---

Funkcja udostępniania openlegion umożliwia tworzenie publicznych linków do konwersacji openlegion, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, openlegion:
...
openlegion obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie openlegion korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `openlegion.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu openlegion w Twojej organizacji.
