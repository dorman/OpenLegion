...
Utwórz `.openlegion/commands/test.md`:
...
Możesz zdefiniować polecenia w `openlegion.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji openlegion:
...
- Globalnie: `~/.config/openlegion/commands/`
- Na projekt: `.openlegion/commands/`
...
openlegion zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
