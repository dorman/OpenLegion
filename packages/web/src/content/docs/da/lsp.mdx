---
title: LSP-servere
description: OpenLegion integreres med dine LSP-servere.
---

OpenLegion kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

OpenLegion leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OPENLEGION_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og openlegion åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din openlegion-konfiguration.
