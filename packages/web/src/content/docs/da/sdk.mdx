...
Brug den til at bygge integrasjoner og kontrollere openlegion programmatisk.
...
Opret en forekomst av openlegion:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `openlegion.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av openlegion, kan du oprete en klientforekomst for at koble til den:
