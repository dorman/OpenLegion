...
Agentferdigheter lar OpenLegion oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går OpenLegion opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
OpenLegion viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `openlegion.json`:
