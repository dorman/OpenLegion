...
Kreiraj `.openlegion/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenLegion konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenLegion [config](/docs/config):
...
- Globalno: `~/.config/openlegion/commands/`
- Po projektu: `.openlegion/commands/`
...
OpenLegion uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
