---
title: Compartilhar
description: Compartilhe suas conversas do openlegion.
---

O recurso de compartilhamento do openlegion permite que você crie links públicos para suas conversas do openlegion, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o openlegion:
...
O openlegion suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o openlegion usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `openlegion.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o openlegion em sua organização.
