---
title: TUI
description: استخدام واجهة المستخدم TUI في OpenLegion.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر OpenLegion واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل OpenLegion إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة OpenLegion في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى OpenLegion. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من OpenLegion. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `openlegion.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار OpenLegion بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `openlegion.default`.
