...
import type { MessageV2 } from "openlegion/session/message-v2"
import type { Message } from "openlegion/session/message"
import type { Session } from "openlegion/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.openlegion_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.openlegion_name}>
