...
// test/preload.ts pins OPENLEGION_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.OPENLEGION_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.OPENLEGION_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.OPENLEGION_MODELS_PATH = undefined
  Flag.OPENLEGION_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.OPENLEGION_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.OPENLEGION_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
