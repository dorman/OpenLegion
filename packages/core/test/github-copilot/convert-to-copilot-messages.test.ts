import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@openlegion-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
