  ...
  it.effect("registers configured skill directories and URLs", () =>
    Effect.gen(function* () {
      ...
      expect(sources).toEqual([
        new SkillV2.DirectorySource({ type: "directory", path: AbsolutePath.make("/repo/.opencode/skill") }),
        new SkillV2.DirectorySource({ type: "directory", path: AbsolutePath.make("/repo/.opencode/skills") }),
