...
export class Service extends Context.Service<Service, Interface>()("@openlegion/ProjectReference") {}
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (!Flag.OPENLEGION_EXPERIMENTAL_REFERENCES) return Service.of(inert)
