...
import { ensureProcessMetadata } from "../util/openlegion-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    serviceName: "openlegion",
    serviceVersion: InstallationVersion,
    attributes: {
      ...attributes,
      "deployment.environment.name": InstallationChannel,
      "openlegion.client": Flag.OPENLEGION_CLIENT,
      "openlegion.process_role": processMetadata.processRole,
      "openlegion.run_id": processMetadata.runID,
