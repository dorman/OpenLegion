...
declare const OPENLEGION_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OPENLEGION_LIBC === "undefined" ? undefined : OPENLEGION_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@openlegion/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OPENLEGION_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.OPENLEGION_EXPERIMENTAL_FILEWATCHER) {
