...
import { sanitizedProcessEnv } from "../util/openlegion-process"
...
export class Service extends Context.Service<Service, Interface>()("@openlegion/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".openlegion")) continue
