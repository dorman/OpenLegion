...
export const TypeId: TypeId = "~@openlegion-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@openlegion-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@openlegion-ai/effect-sqlite-node/NodeSqliteClient")
