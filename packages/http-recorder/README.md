...
Internal package; depended on as `@openlegion-ai/http-recorder` from another
workspace package.

```ts
import { HttpRecorder } from "@openlegion-ai/http-recorder"
```
