...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/dorman/OpenLegion/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for dorman/OpenLegion...\n")
...
console.log("Fetching npm all-time downloads for openlegion-ai...\n")
const npmDownloads = await fetchNpmDownloads("openlegion-ai")
