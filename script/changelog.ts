...
Generates UPCOMING_CHANGELOG.md by running the openlegion changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for openlegion run (default: low)
      --quiet            Suppress openlegion command output unless it fails
